...
toolbox run -c base sudo dnf install -y git tmux neovim python3-neovim pass aria2 mpv pandoc make rclone git-annex adobe-source-han-mono-fonts adobe-source-han-sans-cn-fonts adobe-source-han-serif-cn-fonts aspell tig ripgrep aspell-en emacs-nox emacs librime
# set up for blog
